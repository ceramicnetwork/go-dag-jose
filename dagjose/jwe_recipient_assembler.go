...
func (j *jweRecipientAssembler) BeginMap(sizeHint int) (ipld.MapAssembler, error) {
...
func (j *jweRecipientAssembler) BeginList(sizeHint int) (ipld.ListAssembler, error) {
...
func (j *jweRecipientAssembler) AssignInt(i int) error {
